...
<page backtop="135mm" backbottom="0mm" backleft="20mm" backright="20mm">
    <style>
        table th td{
        ...
        .header{
            vertical-align:top;
            text-align: center;
            background-image: url(../images/mails/approval_header_client.jpg);
            height: 517px;
            width: 800px;
        }
        ...
        .footer{
            ...
            text-align: left;
            background-image: url(../images/mails/approval_footer_client.jpg);
    ...
    <page_header>
        <table style="width: 100%;">
            <tr>
                <td style="text-align: center; width: 800px; height: 523px;">
                    <img src="../images/mails/approval_header_client.jpg" alt="">
                    <div class="fecha">
    ...
    <table style="width: 100%;border: solid 1px #5544DD; border-collapse: collapse" align="center">
        ...
        <tbody>
            ...
            <tr>
                <td class="art-link sep-column"><a href="<?php echo $ord->artimage ?>"><?php echo String2PDFString($ord->artimage, 15); ?></a></td>
