	...
	switch($_POST['t']){
		case 'showcateg':
            ...
            $filejs = fopen('js/categ.js', "r");
                  ...
                  //   echo '<pre>';print_r($width.' / '.$height); echo '</pre>';die();
		...
		case 'showinventario':
            ...
            $filejs = fopen('js/inventario.js', "r");
            if ($filejs) {
                while (($linejs = fgets($filejs)) !== false) {
                        $divdetail.= $linejs;
                }
			...
			$result_array=array("vform"=>$divdetail,"vcateg"=>$vcateg,"vsubcat"=>$vsubcat);
			echo json_encode($result_array);
		break;
